...
func (p *postsUsecase) GetPostById(id uint64) (*models.Post, error) {
...
func (p *postsUsecase) GetUserPosts(userId uint64) ([]*models.Post, error) {
...
func (p *postsUsecase) GetCommunityPosts(communityID uint64) ([]*models.Post, error) {

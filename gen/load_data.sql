...
COPY public.users (first_name, last_name, nick_name, avatar_img_id, email, password) FROM '/home/gen/users.csv' DELIMITER ';' CSV HEADER;
...
COPY public.user_posts (user_id, community_id, message, create_date) FROM '/home/gen/user_posts.csv' DELIMITER ';' CSV HEADER;
